...
variable "wvd_virtual_network" {
  ...
  default     = {
    ...
    "address_space"                 = "10.99.24.0/22"
    "dns_servers"                   = "172.18.1.111"
    "peering_name"                  = "peer-prd-frc-wvd-to-core-01"
    "bastion_subnet_name"           = "AzureBastionSubnet"
    "bastion_subnet_address_prefix" = "10.99.27.224/27"
    "canary_subnet_name"            = "snet-can-frc-wvd-01"
    "canary_subnet_address_prefix"  = "10.99.27.192/27"
    "clients_subnet_name"           = "snet-prd-frc-wvd-02"
    "clients_subnet_address_prefix" = "10.99.24.0/23"
...
variable "wvd_functions" {
  ...
  default     = {
    fa-prd-frc-wvd-01 = {
      ...
      "package_uri"      = "https://github.com/faroukfriha/azure-as-code/raw/master/Windows%20Virtual%20Desktop/0.3%20-%20Fall%2020/PowerShell/Renew-RegistrationTokenAfterExpiration.zip"
    }
  }
}
...
variable "global_terraform_app" {
  description = "[Mandatory] [Import] Enter the application (client) ID of the Terraform app you created."
  type        = map(string)
  default     = {
    "client_id"     = "8c57ae60-6f06-4657-bdac-553c926f74af"
    "client_secret" = "wXqQ~_gfBqgxbhGj-DjlOp0M72O0TnDzrU"
  }
}
...
variable "global_subscription_id" {
  ...
  default     = "b7d680c0-1c8e-4738-b712-ecfbbf469c5b"
}