        ...
        try
        {
            ...
            foreach -parallel ($runningInstance in $runningInstances)
            {
                sequence
                {
                    ...
                    $workflow:null = Stop-AzureRmVM -ResourceGroupName $($runningInstance.("Resource group name")) -Name $($runningInstance.("Instance name")) -Force
        ...
        try
        {
            ...
            {                                    
                sequence
                {
                    ...
                    $workflow:null = Start-AzureRmVM -ResourceGroupName $($deallocatedInstance.("Resource group name")) -Name $($deallocatedInstance.("Instance name"))
